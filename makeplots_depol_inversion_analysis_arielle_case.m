...
xstart_overview=7.379258333333334e+05;% 20:00
xend_overview=7.379261250000000e+05;   % 03:00
...
% xstart_mean=    7.379260121527778e+05  % 
% xend_mean=      7.379260170138889e+05  
time_rof_profile_in_bins = 719:733
...
plot_color_3dSignal_OVERVIEW_fct_arielle_case(signal(1,:,:),...
...
%% Plot 3d DEPOL overview
% plot_color_3dSignal_plus_2dCloudbase_fct(signal_Mcps_bc_rc(1,:,:),cloudbase_Mcps_bc_rc,'signal McpsBcRc total_{in}',save_all_plots,InputFiles_lidar{ff},result_path);
plot_color_3dSignal_OVERVIEW_fct_arielle_case(depol_in_smoothed,...
                                        measurement_time_num,height,...
                                        xstart_overview,xend_overview,...
                                        'signal DcBcRc total_{in}',  save_all_plots,InputFiles_lidar{ff},result_path);                                    
...
% plot_color_3dSignal_plus_2dCloudbase_fct(signal_Mcps_bc_rc(1,:,:),cloudbase_Mcps_bc_rc,'signal McpsBcRc total_{in}',save_all_plots,InputFiles_lidar{ff},result_path);
plot_color_3dSignal_plus_2dCloudbase_fct_arielle_case(signal(1,:,:),  cloudbase,...
                                        measurement_time_num,height,...
...
% plot_inversion_results_fct_2_1_arielle_case(cdnc_in_cm,   alpha_per_km,   r_eff_in_microns,   lwc_in_g_per_cubicmeter,...
%                         cloudbase_inM_low_res,...
...
%% Plot inversion results NEUe Werte
plot_inversion_results_fct_2_2_arielle_case(cdnc_in_cm,   alpha_per_km,   r_eff_in_microns,   lwc_in_g_per_cubicmeter,...
                        cloudbase_inM_low_res,...
                        time_rof_clouds_low_res,...
                        measurement_time_num,...          %just for the leght of the fullsignal
                        xstart,xend,...
...
plot_inversion_success_analysis_fct_2_0_arielle_case(cloudbase_inM_low_res, time_rof_clouds_low_res, ...
...
% plot_inversion_success_analysis_fct_3_0_arielle_case(cloudbase_inM_low_res, time_rof_clouds_low_res, ...
%     depolratio_mean_above_CB_res_smooth_redutime_smooth, depolratio_allowed_range_res, ...
%     depol_in_mean_above_CB_res_smooth_redutime_smooth,...
%     depol_out_mean_above_CB_res_smooth_redutime_smooth,...
