...
function plot_color_3dSignal_plus_2dCloudbase_fct_2_0(d3_signal_L,d2_signal_L,...
                                                    num_time_L,height_L,...
...
xlimes=[num_time_L(1) num_time_L(end)];   %                                                 %666*7.5m = 5km
...
date_tick_range = num_time_L(1:60:end);   % 20-> 10min,    60->1/h std
