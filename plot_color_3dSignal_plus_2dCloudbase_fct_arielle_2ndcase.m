...
function plot_color_3dSignal_plus_2dCloudbase_fct_arielle_2ndcase(d3_signal_L,d2_signal_L,...
                                                    num_time_L,height_L,...
...
h = colorbar;
colormap(jet);
set(get(h,'title'),'string',{'Rangecorrected'; 'Signal'},'Fontsize',20);        % Beschriftung der Colorbar
caxis([1*10^3 10^8]);  %% Dushanbe 11.9
                       % Arielle 13.11.  (automatic)     
