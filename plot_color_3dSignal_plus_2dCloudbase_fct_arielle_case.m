...
function plot_color_3dSignal_plus_2dCloudbase_fct_arielle_case(d3_signal_L,d2_signal_L,...
                                                    num_time_L,height_L,...
...
% date_tick_range = num_time_L(677:20:end);   % 20-> 10min,    60->1/h std
% 
% date_minor_tick_range = num_time_L(37:2:end);

date_tick_range = num_time_L(1:20:end);   % 20-> 10min,    60->1/h std

date_minor_tick_range = num_time_L(1:2:end);
