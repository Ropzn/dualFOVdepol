...
function plot_depol_in_out_mean_2_1_fct(s_in,s_out,s_in_err,s_out_err, height_L,sig_names,time_rof_profile_in_bins_L,save_all_plots_L,InputFile,result_path_L)
...
xlimes=[-0.1 1];        %  Plot Depolrange
ylimes=[0 5];           %  Plot height range in km
...
errorbar(s_in,height_L,s_in_err,'horizontal' ,'DisplayName','Depol_{in}');
hold on;
