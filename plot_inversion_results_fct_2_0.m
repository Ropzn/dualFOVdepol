...
function plot_inversion_results_fct_2_0(cdnc_in_cm_L,alpha_per_km_L,r_eff_in_microns_L,lwc_in_g_per_cubicmeter_L,...
...
datetick('x',15,'keepticks');           % 15 ist der darstellungsmodus siehe help datetic
