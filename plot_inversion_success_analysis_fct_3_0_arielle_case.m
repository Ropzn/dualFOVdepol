...
ylim([3.0 4.7])   %arielle_case 14-15.5.2019 [3.0 4.7]
...
p2=plot(num_time_rof_clouds,cloud_max_Mpcs_L(4,:),'s','DisplayName','PMax^{out}_{cross}','LineWidth',2);
hold off
set(gca,'fontweight','bold','fontsize',12,'YDir','normal');
legend( 'Location', 'eastoutside');
...
ylim([0 1000])   %arielle_case 14-15.5.2019 [3.0 4.7]
ax.YMinorTick = 'on' %more tick marks
